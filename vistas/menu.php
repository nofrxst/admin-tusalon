    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container headercnt">
        <div class="navbar-header">
          ...
          <!--Imagen-->
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/tusalonlg.png" alt="" width="150px" height="120px"></a>
          <!--Imagen-->
        </div>
        ...
        if($_SESSION['usuario']=="admin"):
         ...
         <?php 
          ...
          <li class="dropdown" >
            <a href="#" style="color: rgb(0, 255, 0)"  class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Usuario: <?php echo $_SESSION['usuario']; ?>  <span class="caret"></span></a>
            <ul class="dropdown-menu">
